# CS224W Final Project: Graph Attention Networks
...
## Model Details
### Training
python main.py --n_node {%num_route%} --graph {%weight_matrix.csv%}

**Default settings**:
* Training configs: argparse is used for passing parameters.
    * n_node=228, graph='default', ks=3, kt=3, n_his=12, n_pred=9
...
Note: it normally takes around 6s on a NVIDIA TITAN Xp for one epoch with the batch size of 50 and n_node of 228.
